...
enum LayerParameter_LayerType {
  ...
  LayerParameter_LayerType_NOISY_DATA = 30,
  LayerParameter_LayerType_POOLING = 17,
  LayerParameter_LayerType_POWER = 26,
  LayerParameter_LayerType_PSNR_LOSS = 31,
  ...
  LayerParameter_LayerType_THRESHOLD = 32,
...
enum ThresholdParameter_ThresholdType {
  ThresholdParameter_ThresholdType_HARD = 0,
  ThresholdParameter_ThresholdType_SOFT_LAYER = 1,
  ThresholdParameter_ThresholdType_SOFT_CHANNEL = 2,
  ThresholdParameter_ThresholdType_SOFT_POINT = 3
};
bool ThresholdParameter_ThresholdType_IsValid(int value);
const ThresholdParameter_ThresholdType ThresholdParameter_ThresholdType_ThresholdType_MIN = ThresholdParameter_ThresholdType_HARD;
const ThresholdParameter_ThresholdType ThresholdParameter_ThresholdType_ThresholdType_MAX = ThresholdParameter_ThresholdType_SOFT_POINT;
const int ThresholdParameter_ThresholdType_ThresholdType_ARRAYSIZE = ThresholdParameter_ThresholdType_ThresholdType_MAX + 1;

const ::google::protobuf::EnumDescriptor* ThresholdParameter_ThresholdType_descriptor();
inline const ::std::string& ThresholdParameter_ThresholdType_Name(ThresholdParameter_ThresholdType value) {
  return ::google::protobuf::internal::NameOfEnum(
    ThresholdParameter_ThresholdType_descriptor(), value);
}
inline bool ThresholdParameter_ThresholdType_Parse(
    const ::std::string& name, ThresholdParameter_ThresholdType* value) {
  return ::google::protobuf::internal::ParseNamedEnum<ThresholdParameter_ThresholdType>(
    ThresholdParameter_ThresholdType_descriptor(), name, value);
}
...
class SolverParameter : public ::google::protobuf::Message {
 public:
  ...
  // optional bool display_verbose = 21 [default = false];
  inline bool has_display_verbose() const;
  inline void clear_display_verbose();
  static const int kDisplayVerboseFieldNumber = 21;
  inline bool display_verbose() const;
  inline void set_display_verbose(bool value);
 ...
 private:
  ...
  inline void set_has_display_verbose();
  inline void clear_has_display_verbose();
...
class LayerParameter : public ::google::protobuf::Message {
 public:
  ...
  static const LayerType NOISY_DATA = LayerParameter_LayerType_NOISY_DATA;
  ...
  static const LayerType PSNR_LOSS = LayerParameter_LayerType_PSNR_LOSS;
  ...
  // optional .caffe.ThresholdParameter threshold_param = 23;
  inline bool has_threshold_param() const;
  inline void clear_threshold_param();
  static const int kThresholdParamFieldNumber = 23;
...
class ThresholdParameter : public ::google::protobuf::Message {
 public:
  ...
  typedef ThresholdParameter_ThresholdType ThresholdType;
  static const ThresholdType HARD = ThresholdParameter_ThresholdType_HARD;
  static const ThresholdType SOFT_LAYER = ThresholdParameter_ThresholdType_SOFT_LAYER;
  static const ThresholdType SOFT_CHANNEL = ThresholdParameter_ThresholdType_SOFT_CHANNEL;
  static const ThresholdType SOFT_POINT = ThresholdParameter_ThresholdType_SOFT_POINT;
  static inline bool ThresholdType_IsValid(int value) {
    return ThresholdParameter_ThresholdType_IsValid(value);
  }
  static const ThresholdType ThresholdType_MIN =
    ThresholdParameter_ThresholdType_ThresholdType_MIN;
  static const ThresholdType ThresholdType_MAX =
    ThresholdParameter_ThresholdType_ThresholdType_MAX;
  static const int ThresholdType_ARRAYSIZE =
    ThresholdParameter_ThresholdType_ThresholdType_ARRAYSIZE;
  static inline const ::google::protobuf::EnumDescriptor*
  ThresholdType_descriptor() {
    return ThresholdParameter_ThresholdType_descriptor();
  }
  static inline const ::std::string& ThresholdType_Name(ThresholdType value) {
    return ThresholdParameter_ThresholdType_Name(value);
  }
  static inline bool ThresholdType_Parse(const ::std::string& name,
      ThresholdType* value) {
    return ThresholdParameter_ThresholdType_Parse(name, value);
  }

  // accessors -------------------------------------------------------

  // optional .caffe.ThresholdParameter.ThresholdType type = 1 [default = HARD];
  inline bool has_type() const;
  inline void clear_type();
  static const int kTypeFieldNumber = 1;
  inline ::caffe::ThresholdParameter_ThresholdType type() const;
  inline void set_type(::caffe::ThresholdParameter_ThresholdType value);

  // optional .caffe.FillerParameter threshold_filler = 7;
  inline bool has_threshold_filler() const;
  inline void clear_threshold_filler();
  static const int kThresholdFillerFieldNumber = 7;
  inline const ::caffe::FillerParameter& threshold_filler() const;
  inline ::caffe::FillerParameter* mutable_threshold_filler();
  inline ::caffe::FillerParameter* release_threshold_filler();
  inline void set_allocated_threshold_filler(::caffe::FillerParameter* threshold_filler);

  // @@protoc_insertion_point(class_scope:caffe.ThresholdParameter)
 private:
  inline void set_has_type();
  inline void clear_has_type();
  inline void set_has_threshold_filler();
  inline void clear_has_threshold_filler();

  ::google::protobuf::UnknownFieldSet _unknown_fields_;

  ::caffe::FillerParameter* threshold_filler_;
  int type_;
...
// optional bool display_verbose = 21 [default = false];
inline bool SolverParameter::has_display_verbose() const {
  return (_has_bits_[0] & 0x00100000u) != 0;
}
inline void SolverParameter::set_has_display_verbose() {
  _has_bits_[0] |= 0x00100000u;
}
inline void SolverParameter::clear_has_display_verbose() {
  _has_bits_[0] &= ~0x00100000u;
}
inline void SolverParameter::clear_display_verbose() {
  display_verbose_ = false;
  clear_has_display_verbose();
}
inline bool SolverParameter::display_verbose() const {
  return display_verbose_;
}
inline void SolverParameter::set_display_verbose(bool value) {
  set_has_display_verbose();
  display_verbose_ = value;
}
...
// optional .caffe.ThresholdParameter.ThresholdType type = 1 [default = HARD];
inline bool ThresholdParameter::has_type() const {
  return (_has_bits_[0] & 0x00000001u) != 0;
}
inline void ThresholdParameter::set_has_type() {
  _has_bits_[0] |= 0x00000001u;
}
inline void ThresholdParameter::clear_has_type() {
  _has_bits_[0] &= ~0x00000001u;
}
inline void ThresholdParameter::clear_type() {
  type_ = 0;
  clear_has_type();
}
inline ::caffe::ThresholdParameter_ThresholdType ThresholdParameter::type() const {
  return static_cast< ::caffe::ThresholdParameter_ThresholdType >(type_);
}
inline void ThresholdParameter::set_type(::caffe::ThresholdParameter_ThresholdType value) {
  assert(::caffe::ThresholdParameter_ThresholdType_IsValid(value));
  set_has_type();
  type_ = value;
}

// optional .caffe.FillerParameter threshold_filler = 7;
inline bool ThresholdParameter::has_threshold_filler() const {
  return (_has_bits_[0] & 0x00000002u) != 0;
}
inline void ThresholdParameter::set_has_threshold_filler() {
  _has_bits_[0] |= 0x00000002u;
}
inline void ThresholdParameter::clear_has_threshold_filler() {
  _has_bits_[0] &= ~0x00000002u;
}
inline void ThresholdParameter::clear_threshold_filler() {
  if (threshold_filler_ != NULL) threshold_filler_->::caffe::FillerParameter::Clear();
  clear_has_threshold_filler();
}
inline const ::caffe::FillerParameter& ThresholdParameter::threshold_filler() const {
  return threshold_filler_ != NULL ? *threshold_filler_ : *default_instance_->threshold_filler_;
}
inline ::caffe::FillerParameter* ThresholdParameter::mutable_threshold_filler() {
  set_has_threshold_filler();
  if (threshold_filler_ == NULL) threshold_filler_ = new ::caffe::FillerParameter;
  return threshold_filler_;
}
inline ::caffe::FillerParameter* ThresholdParameter::release_threshold_filler() {
  clear_has_threshold_filler();
  ::caffe::FillerParameter* temp = threshold_filler_;
  threshold_filler_ = NULL;
  return temp;
}
inline void ThresholdParameter::set_allocated_threshold_filler(::caffe::FillerParameter* threshold_filler) {
  delete threshold_filler_;
  threshold_filler_ = threshold_filler;
  if (threshold_filler) {
    set_has_threshold_filler();
  } else {
    clear_has_threshold_filler();
...
template <>
inline const EnumDescriptor* GetEnumDescriptor< ::caffe::ThresholdParameter_ThresholdType>() {
  return ::caffe::ThresholdParameter_ThresholdType_descriptor();
}
template <>
