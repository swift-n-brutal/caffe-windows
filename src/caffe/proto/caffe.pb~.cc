...
const ::google::protobuf::EnumDescriptor* ThresholdParameter_ThresholdType_descriptor_ = NULL;
...
void protobuf_AssignDesc_caffe_2eproto() {
  ...
  static const int SolverParameter_offsets_[21] = {
    ...
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(SolverParameter, display_verbose_),
  };
  ...
  static const int ThresholdParameter_offsets_[2] = {
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ThresholdParameter, type_),
    GOOGLE_PROTOBUF_GENERATED_MESSAGE_FIELD_OFFSET(ThresholdParameter, threshold_filler_),
  };
  ...
  ThresholdParameter_ThresholdType_descriptor_ = ThresholdParameter_descriptor_->enum_type(0);
...
void protobuf_AddDesc_caffe_2eproto() {
  ...
  ::google::protobuf::DescriptorPool::InternalAddGeneratedFile(
    ...
    "ce_backward\030\005 \001(\010:\005false\"\237\004\n\017SolverParam"
    ...
    " \001(\0132\027.caffe.DropoutParameter\0221\n\017hdf5_da"
    ...
    "owerParameter\0222\n\017threshold_param\030\027 \001(\0132\031"
    ".caffe.ThresholdParameter\0225\n\021window_data"
    "_param\030\024 \001(\0132\032.caffe.WindowDataParameter"
    ...
    "_filler\030\010 \001(\0132\026.caffe.FillerParameter\"\233\001"
    ...
    "lingParameter.PoolMethod:\003MAX\022\023\n\013kernel_"
    ...
    "pad\030\n \001(\r:\0010\022\027\n\tcrop_mode\030\013 \001(\t:\004warp\"\320\001"
    "\n\022ThresholdParameter\022;\n\004type\030\001 \001(\0162\'.caf"
    "fe.ThresholdParameter.ThresholdType:\004HAR"
    "D\0220\n\020threshold_filler\030\007 \001(\0132\026.caffe.Fill"
    "erParameter\"K\n\rThresholdType\022\010\n\004HARD\020\000\022\016"
    "\n\nSOFT_LAYER\020\001\022\020\n\014SOFT_CHANNEL\020\002\022\016\n\nSOFT"
    "_POINT\020\003\"\357\007\n\020V0LayerParameter\022\014\n\004name\030\001 "
...
const int SolverParameter::kDisplayVerboseFieldNumber;
#endif  // !_MSC_VER
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 20: {
        ...
        if (input->ExpectTag(168)) goto parse_display_verbose;
        break;
      }
      ...
      case 21: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_VARINT) {
         parse_display_verbose:
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   bool, ::google::protobuf::internal::WireFormatLite::TYPE_BOOL>(
                 input, &display_verbose_)));
...
void SolverParameter::SerializeWithCachedSizes(
  ...
  // optional bool display_verbose = 21 [default = false];
  if (has_display_verbose()) {
    ::google::protobuf::internal::WireFormatLite::WriteBool(21, this->display_verbose(), output);
  }
...
::google::protobuf::uint8* SolverParameter::SerializeWithCachedSizesToArray(
  ...
  // optional bool display_verbose = 21 [default = false];
  if (has_display_verbose()) {
    target = ::google::protobuf::internal::WireFormatLite::WriteBoolToArray(21, this->display_verbose(), target);
  }
...
void SolverParameter::MergeFrom(const SolverParameter& from) {
  ...
  if (from._has_bits_[16 / 32] & (0xffu << (16 % 32))) {
    ...
    if (from.has_display_verbose()) {
      set_display_verbose(from.display_verbose());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
void SolverParameter::Swap(SolverParameter* other) {
  if (other != this) {
    ...
    std::swap(display_verbose_, other->display_verbose_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
...
const LayerParameter_LayerType LayerParameter::NOISY_DATA;
const LayerParameter_LayerType LayerParameter::POOLING;
const LayerParameter_LayerType LayerParameter::POWER;
const LayerParameter_LayerType LayerParameter::PSNR_LOSS;
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 22: {
        ...
        if (input->ExpectTag(186)) goto parse_threshold_param;
        break;
      }
...
void LayerParameter::SerializeWithCachedSizes(
  ...
  if (has_threshold_param()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      23, this->threshold_param(), output);
  }
...
::google::protobuf::uint8* LayerParameter::SerializeWithCachedSizesToArray(
  ...
  if (has_threshold_param()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        23, this->threshold_param(), target);
  }
...
const ::google::protobuf::EnumDescriptor* ThresholdParameter_ThresholdType_descriptor() {
  protobuf_AssignDescriptorsOnce();
  return ThresholdParameter_ThresholdType_descriptor_;
}
...
#ifndef _MSC_VER
const ThresholdParameter_ThresholdType ThresholdParameter::HARD;
const ThresholdParameter_ThresholdType ThresholdParameter::SOFT_LAYER;
const ThresholdParameter_ThresholdType ThresholdParameter::SOFT_CHANNEL;
const ThresholdParameter_ThresholdType ThresholdParameter::SOFT_POINT;
const ThresholdParameter_ThresholdType ThresholdParameter::ThresholdType_MIN;
const ThresholdParameter_ThresholdType ThresholdParameter::ThresholdType_MAX;
const int ThresholdParameter::ThresholdType_ARRAYSIZE;
#endif  // _MSC_VER
#ifndef _MSC_VER
const int ThresholdParameter::kTypeFieldNumber;
const int ThresholdParameter::kThresholdFillerFieldNumber;
#endif  // !_MSC_VER
...
void ThresholdParameter::InitAsDefaultInstance() {
  threshold_filler_ = const_cast< ::caffe::FillerParameter*>(&::caffe::FillerParameter::default_instance());
}
  ...
  while ((tag = input->ReadTag()) != 0) {
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      case 1: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
          ...
          DO_((::google::protobuf::internal::WireFormatLite::ReadPrimitive<
                   int, ::google::protobuf::internal::WireFormatLite::TYPE_ENUM>(
                 input, &value)));
          if (::caffe::ThresholdParameter_ThresholdType_IsValid(value)) {
            set_type(static_cast< ::caffe::ThresholdParameter_ThresholdType >(value));
          } else {
            mutable_unknown_fields()->AddVarint(1, value);
          }
        } else {
        ...
        if (input->ExpectTag(58)) goto parse_threshold_filler;
        break;
      }
      ...
      case 7: {
        if (::google::protobuf::internal::WireFormatLite::GetTagWireType(tag) ==
            ::google::protobuf::internal::WireFormatLite::WIRETYPE_LENGTH_DELIMITED) {
         parse_threshold_filler:
          DO_(::google::protobuf::internal::WireFormatLite::ReadMessageNoVirtual(
               input, mutable_threshold_filler()));
        } else {
          goto handle_uninterpreted;
        }
        if (input->ExpectAtEnd()) return true;
...
void ThresholdParameter::SerializeWithCachedSizes(
  ...
  if (has_threshold_filler()) {
    ::google::protobuf::internal::WireFormatLite::WriteMessageMaybeToArray(
      7, this->threshold_filler(), output);
  }
...
::google::protobuf::uint8* ThresholdParameter::SerializeWithCachedSizesToArray(
  ...
  if (has_threshold_filler()) {
    target = ::google::protobuf::internal::WireFormatLite::
      WriteMessageNoVirtualToArray(
        7, this->threshold_filler(), target);
  }
...
void ThresholdParameter::MergeFrom(const ThresholdParameter& from) {
  ...
  if (from._has_bits_[0 / 32] & (0xffu << (0 % 32))) {
    ...
    if (from.has_threshold_filler()) {
      mutable_threshold_filler()->::caffe::FillerParameter::MergeFrom(from.threshold_filler());
    }
  }
  mutable_unknown_fields()->MergeFrom(from.unknown_fields());
}
...
void ThresholdParameter::Swap(ThresholdParameter* other) {
  if (other != this) {
    std::swap(type_, other->type_);
    std::swap(threshold_filler_, other->threshold_filler_);
    std::swap(_has_bits_[0], other->_has_bits_[0]);
    _unknown_fields_.Swap(&other->_unknown_fields_);
    std::swap(_cached_size_, other->_cached_size_);
  }
